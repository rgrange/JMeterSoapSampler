...
public class UndoableJTextArea extends JTextArea {
	...
	private TreeMap<Object, UndoableJTextArea.UndoableDocument> undoableDocumentMap = new TreeMap<>();
	...
	public void switchDocument(Object container, Object keyObj, String contents) {
		...
		UndoableJTextArea.UndoableDocument ud = this.undoableDocumentMap.get(key);
		if(ud == null) {
